...
public class LobsterEntity extends WaterAnimal implements IAnimatable, Bucketable {
    ...
    public LobsterEntity(EntityType<? extends WaterAnimal> p_27557_, Level p_27558_) {
    ...
    public static boolean canSpawnUnderWater(EntityType<LobsterEntity> entity, ServerLevelAccessor accessor, MobSpawnType type, BlockPos pos, Random random) {
        return pos.getY() < accessor.getSeaLevel() - 4 && pos.getY() > accessor.getSeaLevel() - 30;
    }
    ...
    public ItemStack getBucketItemStack() {
        ItemStack stack = new ItemStack(ItemInit.LOBSTER_BUCKET.get());
        if (this.hasCustomName()) {
